...
mkdir build
cd build
cmake .. -DTBB_LIBRARY_DIR=/opt/intel/tbb/lib/intel64/gcc4.8 -DTBB_INCLUDE_DIR=/opt/intel/tbb/include/tbb -DTBB_LIB_COMPONENTS=./opt/intel/tbb/lib/intel64/gcc4.8/libtbb.so >> openvdb_install.log
